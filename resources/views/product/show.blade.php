        ...
        <div class="flex flex-wrap">
            <div class="w-full flex">
                ...
                <div class="ml-10 mt-10">
                    <span>Category: <b>{{ $product->Category->name }}</b></span>
                    <p class="font-semibold pt-8">Lorem ipsum dolor sit, amet consectetur adipisicing
                        ...
                        sapiente praesentium aspernatur, rem recusandae itaque blanditiis excepturi quasi facere ex!</p>
                        <div class="controls mt-12 float-right">
                            <form action="{{ route('cart.add', $product->id) }}" method="POST">
                                ...
                                <button type="submit"
                                    class="bg-primary inline-flex items-center justify-center rounded-md py-2 px-10 text-center text-base font-normal text-white ">Add
                                    to cart</button>
                            </form>
                        </div>
                </div>
